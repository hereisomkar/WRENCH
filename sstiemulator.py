...
if sys.version_info.major != 3 or sys.version_info.minor < 6:
    print('\033[91m[!]\033[0m SSTIemulator was created for Python3.6 and above. Python'+str(sys.version_info.major)+'.'+str(sys.version_info.minor)+' is not supported!')
    sys.exit()
if sys.version_info.minor > 13:
    print('\033[33m[!]\033[0m This version of SSTIemulator was not tested with Python3.'+str(sys.version_info.minor))
import importlib
import os
...
def main():
    ...
    if not (args['url'] or args['interactive'] or args['load_urls'] or args['load_forms']):
        # no target specified
        log.log(22, 'SSTIemulator requires target URL (-u, --url), URLs/forms file (--load-urls / --load-forms) '
                    'or interactive mode (-i, --interactive)')
    elif args['interactive']:
        # interactive mode
        log.log(23, "Starting SSTIemulator in interactive mode. Type 'help' to see the details.")
