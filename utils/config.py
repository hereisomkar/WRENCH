...
# Defaults to be overwritten by config.json, ~/.sstiemulator/config.json, user-supplied config and arguments
defaults = {
    "base_path": "~/.sstiemulator/",
    "crawl_depth": 0,
    "marker": '*',
    "data_type": "form",
    "level": 1,
    ...
    "user_agent": f'SSTIemulator/{version}',
    "interactive": False,
    "random_agent": False,
    "verify_ssl": False,
    "forms": False,
...
base_path = os.path.expanduser(config.get("base_path", "~/.sstiemulator/"))
